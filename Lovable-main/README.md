...
Also to run it
1. go to twilio
2. login using automatedindustrymachinery@gmail.com
3. go to active numbers and then give it the ngrok link
4. Also make sure to have isd recharge on your mobile phone
5. And to connect it on whatsapp go to messaging on twilio.

Also to connect it to vercel - 
1. Just login to verel using automatedindustrymachinery@gmail.com account
2. Give it the token id